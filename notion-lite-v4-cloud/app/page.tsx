...
export default function Home(){
 ...
 const markPending=(key:string,v:boolean)=>{
   setPendingOps(x=>({...x,[key]:v}));
 };
 const mutateLocal=async<T,>(key:string,fn:()=>void,remote:()=>Promise<T>)=>{
